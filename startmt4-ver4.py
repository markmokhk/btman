...
bt(symbol="AUDNZD", expert="Moving Average", setfile="TestExpertParameters.set", period="H1", from_date=datetime(2024, 7, 15), to_date=datetime(2024, 7, 31), every_period="3D")
